...
print("Reading GO...")
t1 = Sys.time()
go_knowledge_full = reading_db("data/9606_go_knowledge_full.tsv", separator = "\t")
...
t1 = Sys.time()
BPGOterms = reading_db("../data/BPGOterms.txt")
CCGOterms = reading_db("../data/CCGOterms.txt")
MFGOterms = reading_db("../data/MFGOterms.txt")
...
print("Writing sets...")
t1 = Sys.time()
write.table(HumanPPI700_GO_CC, file = "../output/HumanPPI700_GO_CC.txt")
write.table(HumanPPI700_GO_CC_conf, file = "../output/HumanPPI700_GO_CC_conf.txt")
write.table(HumanPPI900_GO_CC, file = "../output/HumanPPI900_GO_CC.txt")
write.table(HumanPPI900_GO_CC_conf, file = "../output/HumanPPI900_GO_CC_conf.txt")
write.table(HumanPPI700_GO_MF, file = "../output/HumanPPI700_GO_MF.txt")
write.table(HumanPPI700_GO_MF_conf, file = "../output/HumanPPI700_GO_MF_conf.txt")
write.table(HumanPPI900_GO_MF, file = "../output/HumanPPI900_GO_MF.txt")
write.table(HumanPPI900_GO_MF_conf, file = "../output/HumanPPI900_GO_MF_conf.txt")
write.table(HumanPPI700_GO_BP, file = "../output/HumanPPI700_GO_BP.txt")
write.table(HumanPPI700_GO_BP_conf, file = "../output/HumanPPI700_GO_BP_conf.txt")
write.table(HumanPPI900_GO_BP, file = "../output/HumanPPI900_GO_BP.txt")
write.table(HumanPPI900_GO_BP_conf, file = "../output/HumanPPI900_GO_BP_conf.txt")
t2 = Sys.time()
print(paste("Writing finish in", t2 - t1))
