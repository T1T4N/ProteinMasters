...
currentWorkingEdges = c(41:15000) 
...
resnik_content_file = paste(paste("resnik", "content", (currentWorkingEdges[1]+set_starting), (currentWorkingEdges[length(currentWorkingEdges)]+45000), sep = "_"), ".txt", sep = "")
wang_content_file =  paste(paste("wang", "content", (currentWorkingEdges[1]+set_starting), (currentWorkingEdges[length(currentWorkingEdges)]+45000), sep = "_"), ".txt", sep = "")
jacard_content_file =  paste(paste("jacard", "content", (currentWorkingEdges[1]+set_starting), (currentWorkingEdges[length(currentWorkingEdges)]+45000), sep = "_"), ".txt", sep = "")
