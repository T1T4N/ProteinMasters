...
fidCC1=fopen('../output/CCGOterms.txt','wt');
fidCC2=fopen('../output/CCGOfull.txt','wt');
fprintf(fidCC1,'%s\n',CCgo_id{:});
len=size(CCtermi);
for counter=1:len(1)
...
fidMF1=fopen('../output/MFGOterms.txt','wt');
fidMF2=fopen('../output/MFGOfull.txt','wt');
fprintf(fidMF1,'%s\n',MFgo_id{:});
len=size(MFtermi);
for counter=1:len(1)
...
fidBP1=fopen('../output/BPGOterms.txt','wt');
fidBP2=fopen('../output/BPGOfull.txt','wt');
fprintf(fidBP1,'%s\n',BPgo_id{:});
len=size(BPtermi);
for counter=1:len(1)
